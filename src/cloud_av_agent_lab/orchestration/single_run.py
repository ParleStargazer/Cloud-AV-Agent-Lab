...
NONFATAL_REMOTE_EXECUTION_ERROR_MARKERS = {
    ...
    "winerror 193": "unmatched_instruction",
    "winerror: 193": "unmatched_instruction",
    "errno=8": "unmatched_instruction",
    "bad exe format": "unmatched_instruction",
    "invalid win32": "unmatched_instruction",
    "not a valid win32": "unmatched_instruction",
    "is not a valid win32": "unmatched_instruction",
    "不是有效的 win32": "unmatched_instruction",
